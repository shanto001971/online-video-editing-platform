  ...
  return (
    <div className="">
      ...
      <div className="flex flex-row-reverse group text-white">
        <AiOutlineShoppingCart className="w-[55px] h-[42px] sm:w-[70px] sm:h-[57px] bg-red-500 py-2 sm:py-3 ps-2 sm:ps-3 pr-7 hover:transition-transform ease-out transition-all hover:-translate-x-1" />
