        ...
        <div className="relative overflow-hidden">
            <div className="lg:absolute top-1/5 p-10">
                ...
                <p className="my-5 lg:my-10 font-thin  bg-black bg-opacity-10 bg-repeat-round p-2 rounded">
                 ...
                 <Link to='/dashboard' className="cursor-pointer relative inline-flex items-center justify-center p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 rounded-lg shadow-2xl group">
